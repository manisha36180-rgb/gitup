        ...
        <div className="max-w-[1000px] mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            <div className="bg-white p-6 sm:p-8 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center">
              ...
              <h3 className="text-lg sm:text-xl lg:text-[1.25rem] font-bold text-[#0f2846] mb-3 lg:mb-3">Curated Vessel Listings</h3>
              <p className="text-gray-600 lg:text-[#4b5563] text-sm lg:text-[0.95rem] leading-relaxed">
            ...
            <div className="bg-white p-6 sm:p-8 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center">
              ...
              <h3 className="text-lg sm:text-xl lg:text-[1.25rem] font-bold text-[#0f2846] mb-3 lg:mb-3">Powerful Smart Search</h3>
              <p className="text-gray-600 lg:text-[#4b5563] text-sm lg:text-[0.95rem] leading-relaxed">
            ...
            <div className="bg-white p-6 sm:p-8 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center">
              ...
              <h3 className="text-lg sm:text-xl lg:text-[1.25rem] font-bold text-[#0f2846] mb-3 lg:mb-3">Complete Vessel Profiles</h3>
              <p className="text-gray-600 lg:text-[#4b5563] text-sm lg:text-[0.95rem] leading-relaxed">
            ...
            <div className="bg-white p-6 sm:p-8 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center">
              ...
              <h3 className="text-lg sm:text-xl lg:text-[1.25rem] font-bold text-[#0f2846] mb-3 lg:mb-3">Global Coverage</h3>
              <p className="text-gray-600 lg:text-[#4b5563] text-sm lg:text-[0.95rem] leading-relaxed">
            ...
            <div className="bg-white p-6 sm:p-8 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center">
              ...
              <h3 className="text-lg sm:text-xl lg:text-[1.25rem] font-bold text-[#0f2846] mb-3 lg:mb-3">Real-Time Updates</h3>
              <p className="text-gray-600 lg:text-[#4b5563] text-sm lg:text-[0.95rem] leading-relaxed">
            ...
            <div className="bg-white p-6 sm:p-8 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center">
              ...
              <h3 className="text-lg sm:text-xl lg:text-[1.25rem] font-bold text-[#0f2846] mb-3 lg:mb-3">Trusted & Transparent</h3>
              <p className="text-gray-600 lg:text-[#4b5563] text-sm lg:text-[0.95rem] leading-relaxed">
