    ...
    <div className="w-full bg-[#f8f9fa] py-20 sm:py-32 px-6 min-h-[80vh] flex flex-col items-center text-center">
      <div className="w-full max-w-[800px] flex flex-col items-center">
        ...
        <div className="w-full max-w-[700px] text-left">
          ...
          {/* Contact Form */}
          <form className="bg-white rounded-[2rem] shadow-xl border border-slate-100 p-8 sm:p-14 mb-16 sm:mb-24">
            <div className="flex flex-col gap-8">
              ...
              <div className="flex flex-col gap-3">
                ...
                <input
                  ...
                  className="w-full border-2 border-[#e2e8f0] bg-[#f8fafc] rounded-xl p-5 outline-none text-[#1e293b] text-base transition-colors focus:border-[#0EA5E9]"
                />
              </div>
              ...
              <div className="flex flex-col gap-3">
                ...
                <textarea
                  ...
                  className="w-full border-2 border-[#e2e8f0] bg-[#f8fafc] rounded-xl p-5 outline-none text-[#1e293b] text-base transition-colors focus:border-[#0EA5E9] resize-none"
                />
              </div>

              <button
                type="submit"
                className="w-full bg-[#0EA5E9] text-white font-extrabold text-lg py-5 rounded-xl border-none cursor-pointer mt-4 shadow-[0_8px_20px_rgba(14,165,233,0.3)] hover:bg-[#0284c7] hover:-translate-y-0.5 transition-all"
              >
                Send Message
              </button>
          ...
          <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-8">
            {[
              ...
              <div key={c.label} className="flex-1 min-w-[200px] bg-white rounded-3xl p-10 text-center border border-slate-100 shadow-md hover:shadow-lg transition-shadow">
