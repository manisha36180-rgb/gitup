  ...
  try {
    ...
    return (
      <div className="w-full flex flex-col items-center pt-12 pb-32">
        ...
        {/* Header */}
        <div className="flex flex-col items-center text-center" style={{ paddingBottom: '64px', marginBottom: '32px' }}>
        ...
        {vessels.length === 0 ? (
          ...
          <div className="flex flex-wrap justify-center px-4 sm:px-6" style={{ gap: '32px', paddingTop: '32px', marginTop: '32px' }}>
